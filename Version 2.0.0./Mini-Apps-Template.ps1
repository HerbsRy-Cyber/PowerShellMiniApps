...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    [String]  $AppConfig_Tab_Page_4_Tab_Text                       = ""
    ...
    [String]  $AppConfig_Form_Splash_Label_Heading_1_Text          = ""

    [String]  $AppConfig_Form_Splash_Label_Heading_2_Text          = ""

    [String]  $AppConfig_Form_Splash_Label_1_Text                  = ""
        
    [String]  $AppConfig_Form_Splash_Label_2_Text                  = ""

    [String]  $AppConfig_Form_Splash_Label_3_Text                  = ""


    [Boolean] $AppConfig_Show_Control_Box_Minimise_Box             = $False
    ...
    [Boolean] $AppConfig_Show_Tab_4                                = $False

    [Boolean] $AppConfig_Show_Label_Custom                         = $False

    [Boolean] $AppConfig_Show_Button_Hot_Links                     = $False

    [Boolean] $AppConfig_Show_Button_Hot_Links_Animation           = $False
    ...
    [Boolean] $AppConfig_Form_Splash_Enabled                       = $False

    [Boolean] $AppConfig_Form_Splash_Label_Heading_1_Centered      = $False
    ...
    [Int]     $AppConfig_Form_Splash_Timer                         = 0
...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    [String]  $AppConfig_Image_Hot_Links_Button_Up     = ""
    
    [String]  $AppConfig_Image_Hot_Links_Button_Down   = ""

    [String]  $AppConfig_Image_Form_Splash_Picture_Box = ""
